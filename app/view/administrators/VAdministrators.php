...
class VAdministrators implements View {
    ...
    public function setEditAdministrator (Users $user) {
        $return = '';
    ...
    public function setViewAdministrator (Users $user) {
        $return = '';
        $return .= '
            <table class="form">
                            <tr>
                            ...
                            <tr>
                                <td colspan="2"><button type="button" onclick="carregarPagina ('."'#dadosNovaPagina', 'index.php?site=".Rotas::$ADMINISTRATORS."&subSite=".Rotas::$VIEW_EDIT_ADMINISTRATOR."&emailUser=".$user->getEmail()."'".')">Editar</button>
    ...
    public function setNewAdministrator () {
        $return = '';
        $return .= '<script type="text/javascript" src="js/script.js"></script>
                    <div id="result"></div>
                    <form id="createAdministrator">
                        <table class="form">
                            <tr>
                                <td class="left">Nombre*
    ...
    public function setViewAllAdministrator () {
        $return = '';
        $return .= '
        <script type="text/javascript" src="js/jquery.quick.search.js"></script>
        <button onclick="carregarPaginaAtivarCheck('."'#dadosNovaPagina', 'index.php?site=".Rotas::$ADMINISTRATORS."&subSite=".Rotas::$NEW_ADMINISTRATOR."'".')">Crear Nuevo Administrador</button>
            ...
            if ($user instanceof Users) {
                $return .= '
                    <tr id="tr_'.$user->getId().'">
                        ...
                        <td><img class="imgButton" onclick="'."carregarPaginaAtivarCheck('#dadosNovaPagina', 'index.php?site=".Rotas::$ADMINISTRATORS."&subSite=".Rotas::$VIEW_ADMINISTRATOR."&emailUser=".$user->getEmail()."')".'" src="imagens/view.png">
                        <td><img class="imgButton"  onclick="'."carregarPaginaAtivarCheck('#dadosNovaPagina', 'index.php?site=".Rotas::$ADMINISTRATORS."&subSite=".Rotas::$VIEW_EDIT_ADMINISTRATOR."&emailUser=".$user->getEmail()."')".'" src="imagens/editar.png">
                        <td><img class="imgButton" onclick="deleteUser('."'".$user->getEmail()."', 'index.php?site=".Rotas::$ADMINISTRATORS."&subSite=".Rotas::$DELETE_ADMINISTRATOR."', '".$user->getId()."'".')" src="imagens/excluir.png">
                    </tr>
                ';
            }
        }
