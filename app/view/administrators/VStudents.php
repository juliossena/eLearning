...
class VStudents implements View {
    ...
    public function setEditStudent (Users $user) {
        $return = '';
    ...
    public function setViewStudent (Users $user) {
        $return = '';
        $return .= '
            <table class="form">
                            <tr>
                            ...
                            <tr>
                                <td colspan="2"><button type="button" onclick="carregarPagina ('."'#dadosNovaPagina', 'index.php?site=".Rotas::$STUDENTS."&subSite=".Rotas::$VIEW_EDIT_STUDENT."&emailUser=".$user->getEmail()."'".')">Editar</button>
    ...
    public function setViewAllStudents () {
        $return = '';
        $return .= '
        <script type="text/javascript" src="js/jquery.quick.search.js"></script>
        <button onclick="carregarPaginaAtivarCheck('."'#dadosNovaPagina', 'index.php?site=".Rotas::$STUDENTS."&subSite=".Rotas::$NEW_STUDENT."'".')">Crear Nuevo Estudiante</button>
            ...
            if ($user instanceof Users) {
                $return .= '
                    <tr id="tr_'.$user->getId().'">
                        ...
                        <td><img class="imgButton" onclick="'."carregarPaginaAtivarCheck('#dadosNovaPagina', 'index.php?site=".Rotas::$STUDENTS."&subSite=".Rotas::$VIEW_STUDENT."&emailUser=".$user->getEmail()."')".'" src="imagens/view.png">
                        <td><img class="imgButton"  onclick="'."carregarPaginaAtivarCheck('#dadosNovaPagina', 'index.php?site=".Rotas::$STUDENTS."&subSite=".Rotas::$VIEW_EDIT_STUDENT."&emailUser=".$user->getEmail()."')".'" src="imagens/editar.png">
                        <td><img class="imgButton" onclick="deleteUser('."'".$user->getEmail()."', 'index.php?site=".Rotas::$STUDENTS."&subSite=".Rotas::$DELETE_STUDENT."', '".$user->getId()."'".')" src="imagens/excluir.png">
                    </tr>
                ';
            }
        }
